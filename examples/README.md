...
*Upstream examples from [Solari](https://getsolari.com), kept here verbatim. The application
that uses them lives at the repository root — see [../README.md](../README.md).*
...
| --- | --- | --- |
| [browser-quickstart-ts](browser-quickstart-ts) | TypeScript | Launch a browser, open a page, read it |
| [browser-quickstart-py](browser-quickstart-py) | Python | Launch a browser, open a page, read it |
...
| [browser-session-recording-py](browser-session-recording-py) | Python | Record a session, download the replay |

### Sandbox

| Example | Language | What it shows |
| --- | --- | --- |
| [sandbox-quickstart-ts](sandbox-quickstart-ts) | TypeScript | Run a command, write and read files |
